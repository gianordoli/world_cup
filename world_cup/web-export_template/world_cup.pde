...
void drawTutorial() {
  ...
  //Presets
    ...
    if(showTutorial == 1){
      ...
      textPos.y += 80;
      msg = "2. O total de convocados\natuando naquele país, indicados\npela ÁREA DO CÍRCULO e\npelo NÚMERO dentro dele";
      text(msg, textPos.x, textPos.y);
      ...
      line(textPos.x + 180, arrowPos.y, arrowPos.x, arrowPos.y);
      ellipse(arrowPos.x, arrowPos.y, 3, 3);  
      noFill();
